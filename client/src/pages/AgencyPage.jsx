        ...
        <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl p-8 w-full max-w-md border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Prijavite se da pristupite dashboard-u
            </p>
          </div>
          ...
          <div className="mt-6 text-center">
            <Link
              to="/"
              className="text-tourism-primary hover:text-tourism-secondary transition-colors text-sm"
            >
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-700 mt-2">
                          <strong>Destinacija:</strong> {request.destination}
                        </p>
                        <p className="text-sm text-gray-700">
                          <strong>Budžet:</strong> {request.budget}
                        </p>
                        <p className="text-sm text-gray-700">
                          <strong>Datum:</strong> {request.date}
                        </p>
                        <p className="text-sm text-gray-700 mt-2">
                          {request.message}
                        </p>
            ...
            <div>
              ...
              {travelPackages.length > 0 ? (
                  ...
                  {travelPackages.map((pkg) => (
                    ...
                    >
                      ...
                      <div className="text-xs text-gray-400">
                        Otpremljeno:{" "}
                        {new Date(pkg.created_at).toLocaleDateString("sr-RS")}
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">
                    Nema otpremljenih turističkih paketa
                  </p>
                </div>
              )}
            </div>
