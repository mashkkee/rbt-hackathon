...
const Header = () => {
  ...
  return (
    <header
      className={`fixed bg-black bg-opacity-50 w-full z-50 transition-all duration-300 ${
        isScrolled
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white/95 backdrop-blur-md border-t border-gray-200/50 shadow-lg">
            <div className="px-4 py-6 space-y-4">
              <a
                href="#destinations"
                className="block text-gray-700 font-medium hover:text-tourism-secondary transition-colors"
              >
                Destinacije
              </a>
              <a
